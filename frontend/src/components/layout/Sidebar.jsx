      ...
      <div className="h-20 border-b border-slate-800 flex items-center px-8">
        <div>
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-gradient-to-r from-indigo-500 to-violet-500 flex items-center justify-center font-bold">
              AI
            </div>

            <div>
              <h1 className="font-bold text-lg">Due Diligence</h1>
            ...
            <button
              ...
              ${
                item.active
                  ...
                  : "text-slate-400 hover:bg-slate-800 hover:translate-x-1"
              }`}
            >
              <Icon size={20} />
